...
class MRPGUI(ttk.Frame):
    def __init__(self, master, mrp_system, time_periods_var, display_message):
        """
        ...
        :param display_message: Function to display messages.
        """
    ...
    def display_mrp_tables(self):
        ...
        for material_name, table in mrp_tables.items():
            ...
            headers = [str(i + 1) for i in range(self.time_periods_var.get())]
            indexes = [
                "Demand",
                "Planned Delivery",
                "Available",
